...
const Desktop7 = () => {
  return (
    <div className="w-full relative h-[62.125rem] overflow-hidden bg-[url('/public/desktop--5@3x.png')] bg-cover bg-no-repeat bg-[top] text-left text-[5.313rem] text-base-50 font-lobster-two">
      <img
      ...
      <StateDefaultSize
        ...
        stateDefaultSize48Top="51.438rem"
        stateDefaultSize48Left="35.5rem"
        stateDefaultSize48Height="unset"
      />
      <div className="absolute h-[11.57%] top-[6.14%] left-[calc(50%_-_279px)] inline-block w-[34.938rem]">
        Payment details
      </div>
    </div>
  );
