...
const Desktop4 = () => {
  return (
    <div className="w-full relative h-[64rem] overflow-hidden bg-[url('/public/desktop--4@3x.png')] bg-cover bg-no-repeat bg-[top] text-left text-[1.25rem] text-gray1-200 font-space-grotesk">
      ...
      <div className="absolute top-[42.25rem] left-[14.125rem] w-[34.5rem] h-[4.563rem]">
        <div className="absolute top-[0rem] left-[0rem] shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25),_0px_3px_7.2px_rgba(0,_0,_0,_0.25)_inset] rounded-lg bg-whitesmoke w-[34.5rem] h-[4.563rem]" />
        <div className="absolute top-[0.813rem] left-[1.719rem] inline-block w-[6.006rem]">
          Message
        </div>
      </div>
